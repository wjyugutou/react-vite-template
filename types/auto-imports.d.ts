...
export {}
declare global {
  const ErrorBoundary: typeof import('../src/components/ErrorBoundary')['default']
  const LazyLoad: typeof import('../src/components/LazyLoad')['default']
  ...
  const useHtml: typeof import('../src/hooks/useHtml')['default']
  ...
  const useRouteLoaderData: typeof import('react-router-dom')['useRouteLoaderData']
...
declare global {
  // @ts-ignore
  export type { AuthRoute, UserState } from '../src/store/user'
